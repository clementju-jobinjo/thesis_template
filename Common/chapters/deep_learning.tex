...
A multilayer perceptron is an artifical neural network type. Article \cite{23} defines the multilayer perceptrons in the following way: "Multilayer perceptron are feedforward networks with one or more layers of units between the
