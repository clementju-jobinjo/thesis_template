...
Figure \ref{fig:challenge_all_results_experiment} presents the metrics achieved by the model trained with all available data as training set at each epoch.\\
Figure \ref{fig:results_for_all_models_challenge} shows the performance of the model saved at different epoch on the official challenge test set. The best AUC achieved on the challenge is 0.76. Figure \ref{fig:paper_reprodution_results_challenge2} illustrates the participation to
