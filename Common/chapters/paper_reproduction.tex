...
\setlength{\marginparwidth}{3cm}\leavevmode \marginnote{\textbf{Julien}}This step can be split into two substeps: aligning and stacking images before augmenting them and splitting them across a training set, a validation set and a test set.
