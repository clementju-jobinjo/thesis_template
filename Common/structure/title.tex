...
\\\vspace*{1ex}\emph{Co-Supervisors:} \\ % Remove these two lines if no co-supervisor is involved
{\cosupname} % Co-supervisor name - remove the \href bracket to remove the link
\end{flushright}
\end{minipage}\\[1cm]

March XX, 2020 % date of the official defense
\vspace*{.06\textheight}
