...
\keywords{Prostate cancer classification, Convolutional Neural Networks (CNN), Transfer learning, PROSTATEx, Machine learning, Artificial intelligence} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
